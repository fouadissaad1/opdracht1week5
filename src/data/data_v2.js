export const DATA = [
    {
        ...
        text: [
            ...
            "De aanleg van een moestuin is niet moeilijk, ook als je geen of weinig ervaring hiermee hebt. Moestuinieren begint met een goede voorbereiding. Het succes van je moestuin heeft alles te maken met de keuze van de plek, de kwaliteit van de grond, de bemesting en het (in)zaaien.",
    ...
    },
    {
        ...
        text: [
            "Gebruik een niet te zware bemesting, daar kunnen kiemplantjes niet goed tegen. ",
            "Een organische bemesting werkt voor een moestuin het beste. ",
            "[[img/potato-800x450.jpg",
            "Over het algemeen geldt dat hoe meer mest, hoe meer blad. ",
